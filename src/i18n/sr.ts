...
export const sr: Strings = {
  ...
  ui: {
    ...
    needAccount: "Nemaš nalog?",
    signedInAs: "Prijavljen kao",
    boardBlurb: "Dele se samo ovi brojevi. Ništa što napišeš ne napušta tvoj nalog.",
    boardEmpty: "Još niko ne deli rezultate.",
    shareScores: "Prikaži me na zajedničkoj tabeli",
    shareScoresHint: "Deli tvoj zamah, nivo i niz sa ostalim nalozima na ovom serveru. Tvoji zapisi se nikada ne dele.",
    notSharing: "Sakriven si sa tabele.",
    rank: "Mesto",
    player: "Ime",
    overall: "Ukupno",
    youLabel: "ti",
    level: "Nivo",
    lifetimeXp: "Ukupan XP",
    entries: "zapisa",
